...
<html>
  ...
  <body>
     <table >
      ...
      <s:iterator id="itemTypeList" value="#request.itemTypeList" status="st" var="aa">
         <tr>
          <td><s:property value="#st.count"></s:property></td>  
        <td><s:property value="itType"></s:property></td>
         <td><s:property value="itName"></s:property></td>         
                 <td>
                    <a href="">评分</a>
                 </td>
    	 </tr>
